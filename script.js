...
clearAll();
  container1.appendChild(memeImg);
}
...
function showJoke() {
  ...
  clearAll();
  container2.appendChild(newJoke);
}
...
function showQuote() {
  ...
  const authors=document.querySelector('p')
  ...
  clearAll();
  container3.appendChild(newQuote);
  container3.appendChild(authors);
...
function showRiddle() {
  ...
  container4.appendChild(newRiddle);
  container4.appendChild(newAns);
}
...
function revealAnswers() {
  const container4=document.querySelector('.riddle');
  const rid=container4.querySelector('p')
  const ridAns=document.querySelector('#ans');

  if(rid&& ridAns.hidden){
ridAns.hidden = false;
  }else if(rid){
